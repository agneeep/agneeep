...
I'm an MSc Computer Science student at Queen Mary University of London and a Tech Ambassador at Inditex. I am passionate about **Software Engineering**, **Data Pipelines**, and **Systems Architecture**. 
...
* **Physiologically Adaptive IoT Backend**
  ...
  * Engineered an asynchronous Python pipeline to capture and process live biometric data from Polar BLE sensors in real-time. Designed algorithms to filter signal noise and seamlessly trigger environmental hardware responses.

* **Fault-Tolerant Public Health API Pipeline**
  * *Tech: Python, Pandas, Object-Oriented Programming*
  * Engineered an Object-Oriented API wrapper to fetch, paginate, and process live clinical data from the UKHSA. Developed a fault-tolerant architecture featuring a JSON caching fallback to ensure continuous system stability during API outages. 

* **"out." API Aggregation Web App**
